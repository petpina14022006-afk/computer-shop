      ...
      <section className="max-w-6xl mx-auto py-16">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="border  rounded-lg p-8  hover:shadow-xl hover:shadow-green-500 transition-all duration-300 backdrop-blur-2xl">
            ...
            <p className=" mb-4 text-lg">Reach us via email for detailed inquiries</p>
            <a href="mailto:support@nexacore.com" className="text-green-500 hover:text-green-500/80 transition-all ">
          ...
          <div className="border  rounded-lg p-8  hover:shadow-xl hover:shadow-green-500 transition-all duration-300 backdrop-blur-2xl">
            ...
            <p className=" mb-4 text-lg">Call our support team during business hours</p>
            <a href="tel:+1-555-0123" className="text-green-500 hover:text-green-500/80 transition-all ">
             (+855) 10944454
            </a>
          </div>
